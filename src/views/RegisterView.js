/**
 * RegisterView - Vista de registro de usuario
 * 
 * Principios aplicados:
 * - SRP: Solo renderiza la página de registro
...
export class RegisterView extends BaseView {
            ...
            <div class="login-page">
                <div class="login-container">
                    <div class="login-card">
                        ...
                        <h1 class="login-title">Crea tu cuenta en TravelSplit</h1>
    ...
    afterRender() {
        ...
        console.log('RegisterView renderizada');
    }
